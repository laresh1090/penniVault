...
export default function VendorDashboardError({
  ...
  return (
    <div className="text-center py-5">
      ...
      <h2 style={{ fontSize: 20, fontWeight: 700, color: "#1E252F", marginBottom: 8 }}>Vendor Dashboard Failed to Load</h2>
      <p style={{ color: "#64748B", fontSize: 14, marginBottom: 24 }}>We could not load your vendor dashboard. This might be a temporary issue.</p>
